...
protected:
    ...
    bool note_mundo_framebuffer_draw(char const* operation, WebIDL::UnsignedLong mode, WebIDL::Long count, WebIDL::UnsignedLong type = 0, WebIDL::LongLong offset = 0, bool allow_vulkan_skip_gl_draw = false);
